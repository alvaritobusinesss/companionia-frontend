...
('Reyna', 'Gamer', 'premium', NULL, 'https://companion-ia-2.vercel.app/models/Reyna.jpg', 'Una compañera gamer dominante y poderosa, perfecta para liderar equipos y conquistar mundos virtuales.', ARRAY['gamer', 'dominante', 'líder'], 4.8, 1800),
('Yu', 'Gamer', 'one_time', 4.99, 'https://companion-ia-2.vercel.app/models/Yu.jpg', 'Una compañera gamer única y especializada, experta en juegos indie y aventuras únicas.', ARRAY['gamer', 'indie', 'aventuras'], 4.5, 720);
